		      ...
		      <div class="container">
		        <div class="row">
		          <div class="col-md-12 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
		          	<h1 class="h1-responsive font-weight-bold mt-sm-5" style="color: white"> Submit your lost item here </h1>
		          	<hr class="hr-light">
		            <form action="submitlost-confirmation.php" method="post" id="mainForm" style="color: white">
		            	<div class="form-group">
		            		<label for="name">Name:</label>
   							<input type="name" class="form-control" name="name" placeholder="ex: John Smith">
		            	</div>
		            	<div class="form-group">
		            		<label for="email">Item Lost:</label>
		            	...
		            	<div class="form-group">
		            		<label for="item description">Item Description:</label>
   							<input type="description" class="form-control" name="description" placeholder="Enter a brief description of the item you lost.">
		            	</div>

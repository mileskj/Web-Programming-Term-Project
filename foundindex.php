		        ...
		        <div class="row">
		        	<div class="col-md-3"> </div>
			          <div class="col-md-6 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
			          	<h1 class="h1-responsive font-weight-bold mt-sm-5" style="color: white;"> List of Found Items </h1>
			          	<hr class="hr-light">
				            <?php 
				            	$lines = file('foundlist.txt');
								$search = "FOID#";
								$results = 0;
								clearstatcache();
								if(!filesize('foundlist.txt')) {
								...
								foreach ($lines as $line) {
									if (strpos($line, $search)!== false){
										...
										echo '<strong>Item Found:</strong> <a href="foundlisting.php?id='.urlencode($userarray[0]).'">'.$userarray[2].'</a><br>';
										if ($userarray[3]!== "NOADD"){
											echo '<strong>Found at:</strong> '.$userarray[3].'<br>';
										}
										else {
											echo '<strong>Found at:</strong> Unknown Location<br>';
										}
										echo '</div>';
									}
								}
		  ...
		  <div class="container">
            <div class="row py-5">
              <div class="col-md-12 text-center">
                <p>If you have any questions or need support, contact us at foundatuga@gmail.com. Created by Andrew Alexander, Miles Jordan, Saurav Pawar</p>
              </div>
            </div>
          </div>
	</body>

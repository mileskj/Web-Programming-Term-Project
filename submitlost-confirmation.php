	...
	<body>
		...
		<nav class="navbar navbar-expand-lg navbar-dark fixed-top scrolling-navbar">
		  ...
		  <?php 
			...
			$myfile = fopen("lostlist.txt", "a+") or die("Unable to open file!");
		      ...
		      <div class="container">
		        <div class="row">
		          <div class="col-md-12 white-text text-center text-md-left mt-xl-5 mb-5 wow fadeInLeft" data-wow-delay="0.3s">
		          	...
		          	<hr class="hr-light">
		            <h6 class="mb-4">Your item was just added to the index of lost items. Click the button below to go to the Lost Items List.</h6>
		            <a class="btn btn-outline-white" role="button" href="lostindex.php">Lost Items List</a>
		          </div>
		        </div>
		      </div>
		    </div>		
